...
import { EnterKeyCode } from "../../../Configuration/Utilities/Constants/Constants";
import "./FormComponents.scss";
import Select from "react-select";
import {
  ReactSelectStyle,
  ReactMultiSelectStyle,
} from "../../Assets/Styles/Widgets/SelectStyle/SelectStyle";
        ...
        <React.Fragment>
          <div style={{ width: `${controlwidth}` }}>
            <Select
              ...
              placeholder={
                TxtPrefix === false ? `${ControlTxt}` : `${ControlTxt}`
              }
              ref={ref}
